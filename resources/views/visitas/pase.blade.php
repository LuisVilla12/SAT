...
<body style="font-family: sans-serif; margin: 0; padding: 0;">
    ...
    <form style="background-color: #ffffff; margin: 0 auto;">
        ...
        <table style="width: 100%;">
            <tr>
                <td style="width: 50%;">
                    <label for="fecha" style="font-size: 0.875rem; font-weight: 500; color: #4a5568; text-transform: uppercase;">FECHA:</label>
                    <br>
                    <br>
                    <label for="nombre" style="font-size: 0.875rem; font-weight: 500; color: #4a5568; text-transform: uppercase;">NOMBRE:</label>
                </td>
                <td style="width: 50%;">
                    ...
                    <br>
                    <br>
                    <label for="nombre" style="font-size: 0.875rem; font-weight: 500; color: #4a5568; text-transform: uppercase;">ÁREA:</label>
                </td>
            </tr>
        </table>
        ...
        <div style="margin-bottom: 20px; margin-top: 10px">
            <label for="observaciones" style="font-size: 0.875rem; font-weight: 500; color: #4a5568; text-transform: uppercase;">OBSERVACIONES:</label>
            <textarea id="observaciones" name="observaciones" style="margin-top: 4px; width: 100%; border: 1px solid #d2d6dc; border-radius: 4px; box-shadow: 0 1px 2px rgba(0, 0, 0, 0.05); padding: 8px;" rows="3"></textarea>
        </div>
        ...
        <table style="width: 100%; ">
            <tr>
                <td style="width: 50%; ">
                    <label for="hora_salida" style="font-size: 0.875rem; font-weight: 500; color: #4a5568; text-transform: uppercase;">HORA ENTRADA:</label>

                </td>
                <td style="width: 50%;">
                    <label for="hora_salida" style="font-size: 0.875rem; font-weight: 500; color: #4a5568; text-transform: uppercase;">HORA SALIDA:</label>
                </td>
            </tr>
        </table>
