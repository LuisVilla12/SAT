...
@section('contenido')
    <div class="flex items-center justify-center min-h-screen bg-gray-100">
        <form action="{{ route('auth.edit', $usuario) }}" method="POST" autocomplete="off"
            class="usuario bg-white shadow-lg rounded-lg w-full max-w-lg p-8">
            @csrf
            ...
            <div class="mb-6">
                ...
                <input type="text" id="lastnameP" name="lastnameP" placeholder="Ingrese su apellido paterno"
                    value="{{ $usuario->lastnameP }}"
            ...
            <div class="mb-6">
                ...
                <input type="text" id="lastnameM" name="lastnameM" placeholder="Ingrese su apellido materno"
                    value="{{ $usuario->lastnameM }}"
            ...
            <div class="mb-6">
                ...
                <input type="text" id="company" name="company" placeholder="Ingrese la empresa que representa"
            ...
            <div class="mb-5">
                ...
                <select id="type" name="type" required
                    ...
                    <option @php echo $usuario->type =='2' ? 'selected':''; @endphp value="2">Control de acceso
                    </option>
            ...
            <div>
                ...
                @error('state')
                    <p class="mx-1 mt-1 text-red-500">Debes seleecionar el estado del usuario.</p>
                @enderror
            </div>
            ...
            <div class="flex justify-center gap-5 mt-10">
                ...
                <input type="submit" value="Actualizar"
                    class="enviar bg-blue-500 text-white font-bold py-3 hover:cursor-pointer px-10 rounded-lg hover:bg-blue-600 transition duration-300" />
            </div>
        </form>
    </div>
@endsection
